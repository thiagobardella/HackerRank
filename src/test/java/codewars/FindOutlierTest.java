...
public class FindOutlierTest {
    ...
    public void getFirstOddNumber() {
        int[] integers = {2, 4, 6, 8, 1, 3};
        assertEquals(1, FindOutlier.getFirstOddNumber(integers));
    }

    @Test
    public void getFirstEvenNumber() {
        int[] integers = {5, 4, 6, 8, 1};
        assertEquals(4, FindOutlier.getFirstEvenNumber(integers));
    }
